    ...
    return(
        ...
        <div className='row'>
            ...
            <Link to="/prettybooks">
                ...
                <animated.img src={bin3} className='binstyle' alt='bins' style={{ transform: props.xy.interpolate(trans3) }}/>
                <animated.img src={hand3} className='handstyle' alt='bins' style={{ transform: props.xy.interpolate(trans4) }}/>
            </Link>
            </div>
            </div>
        </div>
