...
export default class tempNav extends React.Component {
  ...
  render() {
    ...
    if (localStorage.getItem("234123jsfjodifisjf232304")) {
      return (
        <Navbar  className="navbarcol" style={navstyle} expand="sm">
          <Navbar.Brand className="jump" href="/eduwelcome"><span className="logotxt">WINC</span></Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              <Nav.Link href="/eduwelcome"><span className="navtxt"><b>Home   </b><span className="break">|</span></span></Nav.Link>
              <Nav.Link href="/edulibrary"><span className="navtxt"><b>Library   </b><span className="break">|</span></span></Nav.Link>
              ...
              <div className="glyph">
                ...
                <NavDropdown  inline title={<span className="navtxt"><b><FontAwesomeIcon className="" icon="user"/> </b><span className="break">|</span></span>} id="basic-nav-dropdown">
                  ...
                  href="/"><span className="droptxt">Logout</span></NavDropdown.Item>
                  <NavDropdown.Divider />
